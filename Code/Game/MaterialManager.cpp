...
//UPDATE
//---------------------------------------------------------------------------------------------------------------------------
void MaterialManager::UpdateUniformOnMaterial(const std::string& materialName, Uniform* uniform) {
...
void MaterialManager::CreateBrickMaterial() {
	...
	brickSampler.AddTexture("gTexDiffuse", Texture::CreateOrGetTexture("Data/Textures/brick_texture.png"));
	brickSampler.AddTexture("gTexNormal", Texture::CreateOrGetTexture("Data/Textures/brick_texture_normal.png"));
	...
	lightPositions.reserve(16);
	lightDirections.reserve(16);
	lightColors.reserve(16);
	minLightDists.reserve(16);
	maxLightDists.reserve(16);
	minPowers.reserve(16);
	maxPowers.reserve(16);
	dirInterps.reserve(16);
	innerThetas.reserve(16);
	outerThetas.reserve(16);
	thetaInnerPowers.reserve(16);
	thetaOuterPowers.reserve(16);
